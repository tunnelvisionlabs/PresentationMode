//------------------------------------------------------------------------------
// <copyright file="IncreaseFontSizePackage.cs" company="Company">
...
namespace PresentationMode
{
    ...
    [Guid(IncreaseFontSizePackageGuids.PackageGuidString)]
    [SuppressMessage("StyleCop.CSharp.DocumentationRules", "SA1650:ElementDocumentationMustBeSpelledCorrectly", Justification = "pkgdef, VS and vsixmanifest are valid VS terms")]
    public sealed class IncreaseFontSizePackage : Package
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IncreaseFontSize"/> class.
        /// </summary>
        public IncreaseFontSizePackage()
        {
